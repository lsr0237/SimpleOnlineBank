<%-- 
    Document   : usermodifypage
    Created on : Dec 9, 2017, 10:27:21 PM
    Author     : Yukyung, Jung
--%>
...
<%
    ...
    String usernum = request.getParameter("modify");
%>
...
<%
    ...
    String sql = "SELECT a.username, a.password, b.role_name FROM users a, role b where a.role_num = b.role_num and a.user_num = ?";
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
                    <h1>User Modify</h1>
                    <div>
                        <form method="post" action="usermodify">
                            <% if (rs.next()){%>
                            ...
                            <br>
                            <input type="text" name="pass" value="<%=rs.getString("password")%>" required>
                            <br>
                            <label>Role: </label>
                            <br>
                            <select name="role">
                            ...
                            <br>
                            <%}%>
                            <input type="hidden" name="usernum" value="<%=usernum%>" required>
                             <br>
                              <br>
