<%-- 
    ...
    Created on : Dec 14, 2017, 6:19:17 PM
    Author     : Yukyung, Jung
--%>
...
<%
    ...
    String sql2 = "SELECT * FROM check_acct where bank_num = ?";
                  ...
                  <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <% while(rs2.next()) { %>
                                <TR>
                                    <td><%=rs2.getInt("check_acct_num")%></td>
                                    <td><%=rs2.getInt("check_amount")%></td>
                                    <td>
                                         <form method="post" action="customerAction">
                                             <input type="hidden" value="<%=rs2.getInt("check_acct_num")%>" name="account_num" >
                                             <input type="hidden" value="deposit" name="actionType" >
                                             <input type="hidden" value="check" name="acctType" >
