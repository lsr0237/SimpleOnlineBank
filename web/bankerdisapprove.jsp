<%-- 
    ...
    Created on : Dec 2, 2017, 9:49:17 PM
    Author     : Kapral, Brittany
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
                    ...
                    <h1>Disapproval Confirmation</h1>
                    <div>
                        
                        <h1>Are you sure want to disapprove Transaction #<%= transnum %>?</h1>
                    
                        <form method =post action="disapprovalprogram">
